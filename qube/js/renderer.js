...
import { characterById } from "./characters.js?v=154";
import { GRID_W, GRID_D, MAX_GRID_W, MAX_GRID_D, TILE, GROUT_INSET, COLORS, CUBE_TYPE, PLAYER_SLIDE_MS, CAM_HALFLIFE_MS } from "./config.js?v=154";
...
export class Renderer {
  ...
  _buildMarkGhost() {
    ...
    new GLTFLoader().load("assets/effects/bomb.glb?v=154", (gltf) => {
