...
import { Debugger } from "./debug.js?v=49";
import { Haptics } from "./haptics.js?v=49";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=49";
