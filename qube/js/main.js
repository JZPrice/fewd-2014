...
import { Debugger } from "./debug.js?v=29";
import { Haptics } from "./haptics.js?v=29";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=29";
