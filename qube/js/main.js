...
import { Debugger } from "./debug.js?v=34";
import { Haptics } from "./haptics.js?v=34";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=34";
