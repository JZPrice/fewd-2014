...
import { Debugger } from "./debug.js?v=32";
import { Haptics } from "./haptics.js?v=32";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=32";
