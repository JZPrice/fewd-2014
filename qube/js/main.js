import { Renderer } from "./renderer.js?v=48";
...
import { Debugger } from "./debug.js?v=48";
import { Haptics } from "./haptics.js?v=48";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=48";
