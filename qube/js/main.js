...
import { Debugger } from "./debug.js?v=71";
import { Haptics } from "./haptics.js?v=71";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=71";
