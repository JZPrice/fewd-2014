...
import { Debugger } from "./debug.js?v=35";
import { Haptics } from "./haptics.js?v=35";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=35";
