...
import { Debugger } from "./debug.js?v=30";
import { Haptics } from "./haptics.js?v=30";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=30";
