...
import { Debugger } from "./debug.js?v=69";
import { Haptics } from "./haptics.js?v=69";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=69";
