...
import { Debugger } from "./debug.js?v=62";
import { Haptics } from "./haptics.js?v=62";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=62";
