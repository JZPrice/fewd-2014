import { Renderer } from "./renderer.js?v=60";
...
import { Debugger } from "./debug.js?v=60";
import { Haptics } from "./haptics.js?v=60";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=60";
