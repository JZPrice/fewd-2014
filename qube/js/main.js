...
import { Debugger } from "./debug.js?v=61";
import { Haptics } from "./haptics.js?v=61";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=61";
