...
import { Debugger } from "./debug.js?v=47";
import { Haptics } from "./haptics.js?v=47";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=47";
