...
import { Debugger } from "./debug.js?v=33";
import { Haptics } from "./haptics.js?v=33";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=33";
