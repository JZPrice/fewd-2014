...
import { Debugger } from "./debug.js?v=36";
import { Haptics } from "./haptics.js?v=36";
import { CHARACTERS, characterById, savedCharacterId, saveCharacterId } from "./characters.js?v=36";
